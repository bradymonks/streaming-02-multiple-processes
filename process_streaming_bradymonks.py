...
for row in reader:
    ...
    index, movie_name,year_of_release,category, run_time, genre, imdb_rating, votes, gross_total = row

    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    fstring_message = f"[{index}, {movie_name}, {year_of_release}, {category}, {run_time},{genre},{imdb_rating},{votes},{gross_total}]"
